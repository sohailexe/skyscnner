...
const FlightsSidebar = () => {
  ...
  return (
    <motion.div className="bg-white p-4 sm:p-5 rounded-xl shadow-lg sticky top-6 lg:top-8">
      ...
      >
        <AccordionItem value="stops" className="border-none">
          <AccordionTrigger className="font-semibold text-gray-700 hover:no-underline py-2.5 text-base rounded-md hover:bg-slate-50 px-3">
            Number of Stops
          </AccordionTrigger>
